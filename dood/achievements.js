...
var DEFS=[
 ...
 {id:'var_INFERNO',name:'FIREPROOF',desc:'Slay an INFERNO demon (LV90+). Walk it off.',hint:'Slay an INFERNO demon (LV90+).'},
  {id:'var_OBLIVION',name:'OBLIVIONED',desc:'Slay an OBLIVION demon (LV110+). Pale as the end of things — shown the door.',hint:'Slay an OBLIVION demon (LV110+).'},
  {id:'var_PRISMATIC',name:'TASTE THE RAINBOW',desc:'Slay a PRISMATIC demon (LV130+). Every color, all at once.',hint:'Slay a PRISMATIC demon (LV130+).'},
